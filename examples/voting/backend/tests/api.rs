...
//! These are tests concerning the API of the voting service. See `tx_logic.rs`
...
/// Wrapper for the voting service API allowing to easily use it
...
fn create_testkit() -> (TestKit, VotingApi) {
